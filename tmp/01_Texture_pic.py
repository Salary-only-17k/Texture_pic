...
class Texture(object):
    def __init__(self,backgroud_img_dir:str,backgroud_xml_dir:str ,mask_dir:str,out_texture_dir:str,out_xml_dir:str,out_detxml_dir:str,out_seg_dir:str ,relabels:dict,seg_labels:dict):
        ...
        self.seg_labels = seg_labels                  # 分割图label
...
def test_api(cfg):
    ...
    cfg.erode = 40
    func = Texture(backgroud_img_dir,backgroud_xml_dir ,mask_dir,out_texture_dir,out_xml_dir,out_detxml_dir,out_seg_dir ,relabels,seg_labels)
    func.loop()
